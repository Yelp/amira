...
class TestS3Handler:
    ...
    def test_get_contents_as_string(self, s3_handler):
        ...
        s3_connection_mock.get_object.assert_called_once_with(
            Bucket="amira-test",
            Key="MALWARE-1564-2016_01_11-10_55_12.tar.gz",
        )
...
class TestS3ResultsUploader:
    ...
    def test_upload_results(self, s3_results_uploader):
        ...
        results = [
            FileMetaInfo("etaoin", StringBuffer("aaaa"), "text/html; charset=UTF-8"),
            FileMetaInfo("shrdlu", StringBuffer("bbbb"), "application/json"),
        ]
